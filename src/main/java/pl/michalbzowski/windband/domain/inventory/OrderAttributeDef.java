...
public class OrderAttributeDef {
    ...
    public static OrderAttributeDef create(Band band, String name, String type, boolean required, int displayOrder, String options) {
        return new OrderAttributeDef(band, name, type, required, displayOrder, options, false);
    }

    public static OrderAttributeDef create(Band band, String name, String type, boolean required, boolean displayInList, int displayOrder, String options) {
        return new OrderAttributeDef(band, name, type, required, displayOrder, options, displayInList);
    }
