...
public class UniformAttributeDef {
    ...
    private UniformAttributeDef(Band band, String name, String type, boolean required, int displayOrder, String options) {
    ...
    public static UniformAttributeDef create(Band band, String name, String type, boolean required, int displayOrder, String options) {
        return new UniformAttributeDef(band, name, type, required, displayOrder, options);
    }
