...
public record ScoresConfig(
        ...
        Long maxZipFileSizeBytes,        // nullable so a missing property defaults cleanly
        Long tempCleanupHours) {         // US-2.5: safety-net age threshold for leftover temp files
    ...
    public static final long DEFAULT_TEMP_CLEANUP_HOURS = 24L;
    ...
    /** Effective temp-file age threshold (hours): falls back to {@link #DEFAULT_TEMP_CLEANUP_HOURS} (US-2.5). */
    public long tempCleanupHoursOr() { return tempCleanupHours == null ? DEFAULT_TEMP_CLEANUP_HOURS : tempCleanupHours; }
}
